...
Замість того, щоб встановлювати Ruby on Rails та текстовий редактор на свій комп'ютер, ти можеш використовувати вебсервіс. Усе, що тобі потрібно це браузер і доступ до інернету. Ця інструкція пояснює як розпочати роботу з  [nitrous.io](https://nitrous.io). Інші сервіси можуть використовувати інші терміни, наприклад 'workspace' замість 'box', але сам процес досить схожий.
